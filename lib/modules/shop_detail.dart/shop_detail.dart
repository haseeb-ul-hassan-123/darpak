                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                            Row(
                                                                          children: [
                                                                            controller.addedService[index].serviceType == 'homeService'.tr || controller.chooseServiceType.value == "homeService"
                                                                                ? Image.asset(
                                                                                    Constant.homeSer,
                                                                                    height: 15,
                                                                                    width: 15,
                                                                                  )
                                                                                : controller.addedService[index].serviceType == 'bothService'.tr || controller.chooseServiceType.value == "bothService"
                                                                                    ? Row(
                                                                                        children: [
                                                                                          Image.asset(
                                                                                            Constant.homeSer,
                                                                            ...
                                                                            SizedBox(
                                                                              ...
                                                                              child: Text(
                                                                                controller.addedService[index].subName == '' ? '0 ${'aED'.tr}' : '${controller.addedService[index].subName} ${'aED'.tr}',
                                                                                maxLines: 1,
